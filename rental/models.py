...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def get_gravatar(self):
        url = get_gravatar_url(self.email, size=150)
        return url


class Genre(models.Model):
    name = models.CharField(
        max_length=30, help_text="The name of genre such as Drama, Art..."
    )
...
class Book(models.Model):
    ...
    isbn = models.CharField(
        "ISBN",
        max_length=13,
        help_text="The ISBN of the Book - 13 Chars",
        default="XXXXXXXXXX",
    )
    language = models.CharField(
        max_length=2, choices=BookLanguage.choices, default=BookLanguage.EN
    )
...
class Borrowed(models.Model):
    user = models.ForeignKey(
        ...
        help_text="username of the borrower",
    ...
    due_back = models.DateTimeField(
        blank=True,
        help_text="This field is not editable, it defaulted to day +1",
        editable=False,
    )
...
class UserProfile(models.Model):
    ...
    user_type = models.CharField(
        max_length=2, choices=UserType.choices, default=UserType.FREE
    )
